...
func (tc *TodoCreate) SetNillableContent(s *string) *TodoCreate {
	if s != nil {
		tc.SetContent(*s)
	}
	return tc
...
func (tc *TodoCreate) SetPriority(i int32) *TodoCreate {
...
func (tc *TodoCreate) SetIsPublic(b bool) *TodoCreate {
	tc.mutation.SetIsPublic(b)
	return tc
}

// SetPinned sets the "pinned" field.
func (tc *TodoCreate) SetPinned(b bool) *TodoCreate {
	tc.mutation.SetPinned(b)
	return tc
}
...
func (tc *TodoCreate) SetNillableOwnerId(s *string) *TodoCreate {
	if s != nil {
		tc.SetOwnerId(*s)
	}
	return tc
...
func (tc *TodoCreate) check() error {
	...
	if _, ok := tc.mutation.IsPublic(); !ok {
		return &ValidationError{Name: "isPublic", err: errors.New(`ent: missing required field "Todo.isPublic"`)}
	}
...
func (tc *TodoCreate) createSpec() (*Todo, *sqlgraph.CreateSpec) {
	...
	if value, ok := tc.mutation.Pinned(); ok {
