...
func ContentVectorIsNil() predicate.Keep {
	return predicate.Keep(sql.FieldIsNull(FieldContentVector))
}

// ContentVectorNotNil applies the NotNil predicate on the "content_vector" field.
func ContentVectorNotNil() predicate.Keep {
	return predicate.Keep(sql.FieldNotNull(FieldContentVector))
}

// SummaryVectorIsNil applies the IsNil predicate on the "summary_vector" field.
func SummaryVectorIsNil() predicate.Keep {
	return predicate.Keep(sql.FieldIsNull(FieldSummaryVector))
}

// SummaryVectorNotNil applies the NotNil predicate on the "summary_vector" field.
func SummaryVectorNotNil() predicate.Keep {
	return predicate.Keep(sql.FieldNotNull(FieldSummaryVector))
}

// TitleVectorIsNil applies the IsNil predicate on the "title_vector" field.
func TitleVectorIsNil() predicate.Keep {
	return predicate.Keep(sql.FieldIsNull(FieldTitleVector))
}

// TitleVectorNotNil applies the NotNil predicate on the "title_vector" field.
func TitleVectorNotNil() predicate.Keep {
	return predicate.Keep(sql.FieldNotNull(FieldTitleVector))
}
